...
- Clone it to your local machine using `git clone https://github.com/yourusername/cheatsheets.git`
- Open the relevant cheat sheet files in a text editor or IDE.
...
5. Submit a pull request explaining what you've done.
